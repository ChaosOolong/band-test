...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(BNO055_I2C_ADDR_SEL_GPIO_Port, BNO055_I2C_ADDR_SEL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BNO055_I2C_ADDR_SEL_Pin BNO055_NRESET_Pin */
  GPIO_InitStruct.Pin = BNO055_I2C_ADDR_SEL_Pin|BNO055_NRESET_Pin;
